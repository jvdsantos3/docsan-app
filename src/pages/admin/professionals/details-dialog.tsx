    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white flex flex-col max-h-[85vh] sm:max-w-[30vw]">
        <DialogHeader className='flex flex-row justify-between items-center'>
          <DialogTitle className='text-blue-1000 font-bold font-lato'>Detalhes do profissional</DialogTitle>
          ...
          <div className="overflow-auto">
            <div className="space-y-4">
              ...
              <div>
                <p className="text-sm text-blue-1000">Informações profissionais</p>

                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-2 font-lato">
                  <div className="flex flex-col gap-2">
                    <Label className="text-gray-600">Ramo de atuação</Label>
                    <p className="text-sm font-medium">{professional.fieldActivity}</p>
                  </div>
                  <div className="flex flex-col gap-2">
        ...
        <DialogFooter >
          <div className='w-full flex flex-row justify-between gap-4'>
            <Button className='w-2/4 text-red-600 border-red-600' type="button" variant="outline">
              <X />
              Reprovar
            </Button>
